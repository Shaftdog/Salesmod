-- Fix create_revision_from_case to use correct column names
-- Changes: required_role -> role, is_blocking -> is_required, 'researcher_level_3' -> 'appraiser'
...
-- Also fix create_correction_request to use correct column names
...
BEGIN
  ...
  -- Create a task for the correction (using correct column names)
  INSERT INTO production_tasks (
    tenant_id,
    production_card_id,
    title,
