...
-- =============================================
-- Insert a sample team goal for current month
-- Note: Replace the created_by UUID with an actual user ID from your profiles table
-- 
-- INSERT INTO public.goals (metric_type, target_value, period_type, period_start, period_end, description, created_by)
-- VALUES (
--   'order_volume',
--   50,
--   'monthly',
