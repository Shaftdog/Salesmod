...
export const clients: Client[] = [
  { id: 'client-1', companyName: 'Global Bank Corp', primaryContact: 'Alice Wonderland', email: 'alice@gbc.com', phone: '(123) 456-7890', address: '123 Main St, San Francisco, CA 94105', billingAddress: '123 Main St, San Francisco, CA 94105', paymentTerms: 30, isActive: true, billingEmailConfirmed: false, createdAt: formatISO(subDays(new Date(), 45)), updatedAt: formatISO(subDays(new Date(), 5)), activeOrders: 5, totalRevenue: 12500 },
  { id: 'client-2', companyName: 'Secure Lending', primaryContact: 'Bob Builder', email: 'bob@securelending.com', phone: '(987) 654-3210', address: '456 Market St, San Francisco, CA 94105', billingAddress: '456 Market St, San Francisco, CA 94105', paymentTerms: 15, isActive: true, billingEmailConfirmed: false, createdAt: formatISO(subDays(new Date(), 120)), updatedAt: formatISO(subDays(new Date(), 20)), activeOrders: 12, totalRevenue: 45000 },
  { id: 'client-3', companyName: 'Fast Mortgage', primaryContact: 'Charlie Chocolate', email: 'charlie@fastmortgage.com', phone: '(555) 555-5555', address: '789 Pine St, Oakland, CA 94607', billingAddress: '789 Pine St, Oakland, CA 94607', paymentTerms: 30, isActive: false, billingEmailConfirmed: false, createdAt: formatISO(subDays(new Date(), 200)), updatedAt: formatISO(subDays(new Date(), 60)), activeOrders: 0, totalRevenue: 5200 },
  { id: 'client-4', companyName: 'Bay Area Credit Union', primaryContact: 'Diana Prince', email: 'diana@bacu.org', phone: '(415) 123-4567', address: '1 Financial Plaza, San Francisco, CA 94111', billingAddress: '1 Financial Plaza, San Francisco, CA 94111', paymentTerms: 30, isActive: true, billingEmailConfirmed: false, createdAt: formatISO(subDays(new Date(), 30)), updatedAt: formatISO(subDays(new Date(), 10)), activeOrders: 8, totalRevenue: 28000 },
  { id: 'client-5', companyName: 'Golden Gate Lenders', primaryContact: 'Ethan Hunt', email: 'ethan@ggl.com', phone: '(510) 987-6543', address: '2000 Bridge Blvd, Sausalito, CA 94965', billingAddress: '2000 Bridge Blvd, Sausalito, CA 94965', paymentTerms: 60, isActive: true, billingEmailConfirmed: false, createdAt: formatISO(subDays(new Date(), 90)), updatedAt: formatISO(subDays(new Date(), 15)), activeOrders: 3, totalRevenue: 15000 },
  { id: 'client-6', companyName: 'Silicon Valley Mortgages', primaryContact: 'Fiona Glenanne', email: 'fiona@svm.com', phone: '(650) 555-1234', address: '3000 Tech Park, Palo Alto, CA 94301', billingAddress: '3000 Tech Park, Palo Alto, CA 94301', paymentTerms: 30, isActive: true, billingEmailConfirmed: false, createdAt: formatISO(subDays(new Date(), 180)), updatedAt: formatISO(subDays(new Date(), 25)), activeOrders: 25, totalRevenue: 150000 },
];
...
export const orders: Order[] = Array.from({ length: 35 }, (_, i) => {
  ...
  return {
    ...
    assignedTo: status !== 'INTAKE' ? assignee.id : undefined,
    assignee: status !== 'INTAKE' ? assignee : undefined,
